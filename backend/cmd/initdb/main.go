...
func main() {
	...
	users := []src.User{
		...
		{Username: "Fred", FirstName: "Fred", LastName: "Flintstone", Email: "freddyflint@aol.com", Phone: "(234) 567-8901"},
